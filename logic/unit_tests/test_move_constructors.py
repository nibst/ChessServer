...
class TestEnPassantConstruction(unittest.TestCase):
    ...
    def test_en_passant_right_blacks(self):
        ...
        execute_function(chess_board)
        self.assertEquals('.', chess_board._get_cell('e', 4))
        self.assertEquals('.', chess_board._get_cell('f', 4))
        self.assertEquals('p', chess_board._get_cell('f', 3))
    ...
    def test_en_passant_left_blacks(self):
        ...
        execute_function(chess_board)
        self.assertEquals('.', chess_board._get_cell('e', 4))
        self.assertEquals('.', chess_board._get_cell('d', 4))
        self.assertEquals('p', chess_board._get_cell('d', 3))
    ...
    def test_en_passant_right_whites(self):
        ...
        self.assertEquals('.', chess_board._get_cell('d', 5))   
        self.assertEquals('.', chess_board._get_cell('e', 5))
        self.assertEquals('P', chess_board._get_cell('e', 6))
    ...
    def test_en_passant_left_whites(self):
        ...
        execute_function(chess_board)
        self.assertEquals('.', chess_board._get_cell('d', 5))
        self.assertEquals('.', chess_board._get_cell('c', 5))   
        self.assertEquals('P', chess_board._get_cell('c', 6))
